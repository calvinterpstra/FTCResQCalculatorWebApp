...
var ScoreLabel = React.createClass({
    ...
    render() {
        return (
            <div>
                <h2 style={styles.headline}> Scores </h2>
                <h3 style={styles.headline2}> Total: { this.getTotalScore(this.props.scores) }</h3>
                <h3 style={styles.headline2}> Partial Target 1: { this.getPartialScore1(this.props.scores) }</h3>
                <h3 style={styles.headline2}> Partial Target 2: { this.getPartialScore2(this.props.scores) }</h3>
            </div>
        );
    }
});
